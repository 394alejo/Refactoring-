...
/**
 * 
 *La clase ImpresorLcd es donde se encuentran los metodos para el procesamiento 
 * de los datos 
 */
public class ImpresorLCD {
   ...
   public  void adicionarSegmento(int segmento) {
     ...
     * a partir de los segmentos adicionar la representacion del digito
     * a la matriz     *
     * @param numero Digito
     */
     ...
     */    
    private void CalculosInicialeDigit(int size, String numeroImp, int espacio) 
    {
        int pivotX = 0;
        char[] digitos;
        ...
        // Inicializa matriz´de la matrzi que impreme los números
        ...
        //recorre el arreglo donde estan almacenados los digitos 
        for (char digito : digitos) {
            
            validacionDigito(digito);
    ...
    /*
    *
    *Metodo encargado de hacer una Validacion  que el caracter sea un digito
    *    
    * @param digito Entrada que contiene el digito a representar
    */
    public static void  validacionDigito(char digito){
    ...
    /*
    *Metodo encargado de realizar la impresion de la matriz resultado
    *
    *
    *obtiene la matriz @param matrizImpr a imprimir del entorno ya definido
    */    
    ...
    public void procesar(String comando, int espacioDig) {
        ...
        CalculosInicialeDigit(tam, parametros[1],espacioDig);
        imprimirResultado();
